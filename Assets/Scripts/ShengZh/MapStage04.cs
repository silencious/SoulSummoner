...
public class MapStage04 : MonoBehaviour {
    ...
    private string path = "D:/UnityTest/SoulSummoner/Assets/Stages/Stage04/Map04.png";
    private string colliderPrefix = "DCollider";
